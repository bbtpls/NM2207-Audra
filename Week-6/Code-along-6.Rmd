...
# pre-allocatting space to store output
...
```
*Added the others for my own reference
<br>
...
for (i in seq_along(a)) {
  # Each entry of out is the sum of the corresponding vector... numbers
  out[i] <- a[i] + b[i]
  }
out
```
...
sample_summary <- function(sample_sizes, fun) {
  ...
  out <- vector("double", length(sample_sizes))
    ...
    for (i in seq_along(sample_sizes)) {
    # Perform operations indicated by fun
