...
```
_*generates normal distribution w rnorm_
<br>
...
```
_*tibble = smth like a list but shld have same no. of entries in all columns
<br>
...
```{r, eval=TRUE,echo=TRUE}
# Enter code here 
calc_sample_mean(10, our_sd = 3)
calc_sample_mean(10, our_mean = 5)
calc_sample_mean(10, 5, 3)
```
<br>
